                ...
                <div className="space-y-3 mt-2 flex justify-center">
                    {payers.length === 0 ? (
                        <div className="font-montserrat flex flex-col items-center justify-center py-16 text-center mx-auto">
                            ...
                            <p className="text-red-200 mb-6 max-w-sm">
                                Vincula tu primer pagador para comenzar a gestionar archivos y procesos de factoraje.
                            </p>
                        </div>
                    ) : (
                            ...
                            <div className="p-8">
                                ...
                                <div className="mt-6">
                                    <button
                                        ...
                                        disabled={!selectedFile || selectedPayerId === null}
                                        className={`cursor-pointer w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 ${!selectedFile || !selectedPayerId ? 'opacity-50 cursor-not-allowed' : ''
                                            }`}
                                    >
                                        Procesar Archivo
                                    </button>
